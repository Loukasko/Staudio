...
public class SampleInit {
    ...
    public SampleInit() {
        ...
        Equipment equip2 = new Equipment(2, "handmade klarino apo kalamaria", Equipment.type.klarino );
        equipmentList.add(equip2);
        Equipment equip3 = new Equipment(3, "5 piece set Pearl", Equipment.type.drums );
        equipmentList.add(equip3);
        Equipment equip4 = new Equipment(4, "Handmade baglamas apo Thommann", Equipment.type.baglamas );
        equipmentList.add(equip1);

        reserv4.setEquipment(equip1);
        reserv4.setEquipment(equip2);
